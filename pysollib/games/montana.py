...
class EasyMontana(Montana):
    Talon_Class = StackWrapper(Montana_Talon, max_rounds=4)
...
registerGame(GameInfo(5311, EasyMontana, "Easy Montana",
                      GI.GT_MONTANA | GI.GT_OPEN, 1, 3, GI.SL_MOSTLY_SKILL,
                      si={"ncards": 48}, altnames="Easy Gaps"))
